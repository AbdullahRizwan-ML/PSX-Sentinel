...
- [x] **Phase 4 Session 1** — Next.js 15 frontend scaffold: design system (Tailwind theme tokens for bullish/bearish/neutral/surface/muted), JWT auth flow (register/login), dashboard, and company-detail page wired against the live backend.
